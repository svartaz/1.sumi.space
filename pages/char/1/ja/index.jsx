  ...
  },
  {
    ...
    table.center(style={width: "50%"})
      ...
      tr
        th 外見
        td: ul
          li 顏: 無表情. じとめ. 威壓的には あらず.
          li 體: 健康的. ひきしまりたる筋肉質. いろしろ.
          li 體毛: 薄墨色. 量は 平均的なれど みづから うすくす.
          li 髮: 薄墨色. みぎめかくれ.
          li 男根: したそり. 勃起時半むけ. 210mm (ただし 數值は 一例なり, 視覺上は なほ おほきくとも よし).
          li 耳と#[a(href="https://en.wikipedia.org/wiki/Prince_Albert_(genital_piercing)") プリンスアルバート]のピアスあり
            ul
              li プリンスアルバートは 陰莖小帶を 切斷せず, ひだりてかはに そる
              li すべて 着脱可能なれば 繪にては 省略せられ う. ことに 插入時は ほとんど かならず プリンスアルバートを はずす.
            T20200317
        td: ul
          li 顏: 童顔. ふとめ つりまゆ. たれめ. あごひげ. いたづらめける ゑかほ.
          li 體: 健康的, 筋肉質 かつ おほから.
          li 體毛: 黑色. やや けふかめ.
          li 髮: 黑色. 兩目かくれ なれど ひだりめ み𛀁かくれす. やや くせけ.
          li 男根: うはそり. 勃起時半むけ. 180mm (ただし 數值は 一例なり, 視覺上は なほ おほきくとも よし).
      tr
        th 自稱
        td: ul
          li 日常にては "わたし"
      ...
      tr
        th 所在
        td(colspan=2) 日本, 武蔵縣 (わが 世界に いふ 東京都)
      tr
        th 言語
        td: ul
          li 日本語 (共通語)
      ...
      tr
        ...
        td: ul
          ...
          li 獨立不羈
          li 快樂主義
          li すすみて ひとと かかはらざれど あへて さけるわけにもあらず. たのまらば やさしく 協力するに くはへ たしかなる 智識 もてば 研究室の 同輩後輩には したはれたり.
        td: ul
          li 論理的
          li 潑溂
          li 社交的
          li 一途
          li ひとと かかはるを このめば 交友關係 ひろし. ひとが いはれたき ことを いふに #[Ruby(main="長", above="た")]く.
      tr
        th 關係
        td(colspan=2): ul
          li 葦原大學 (武蔵縣) の 先輩後輩
          li 盈が 硯を つれいづる かたちにて よく あそぶ. 硯宅にて とまるも おほし. 映畫を よく みる.
          li 硯は 盈の 活潑さや 未知への 積極性を, 盈は 硯の 確乎たる 自我や 思想を それぞれ したふ
          li 約1回/4日の 頻度にて 性交す. 約3/4の 比にて 硯が せめと なる. せめうけに よらず 硯が 主導しがち.
    `
  },
  {
    title: "注意",
    children: pug`
      ul
        ...
        li 禁止: character名稱の 不記載 または ふせ字や 暗號の 使用に よる 檢索性の 阻礙
        li 禁止†: 性別, 國籍, 年齡などに もとづく 差別的なる 限定公開
        li 禁止†: 性器の 檢閱 (mosaic, ぬりつぶし)
        li 非推獎: 乳房の 賦予
        li 非推獎: したくちびるに 線を かき あつみを もたす

      p †公開platformの 規約に 要請せらる ばあひを のぞき はべり
    `
  },
  {
    title: "履歷",
